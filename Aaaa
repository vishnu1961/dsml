chill=['yes','yes','yes','no','no','no','no','yes']
...
chill_encoded=le.fit_transform(chill)
print("Chill:",chill_encoded)
...
print("Flu:",label)
features=list(zip(chill_encoded,runningnose_encoded,headache_encoded,fever_encoded))
print(features)
